...
parser.add_argument('-a', type=str,  default="atlas/ABA_25um_reference.tif", help="atlas file")
parser.add_argument('-aa', type=str, default="atlas/ABA_25um_annotation.tif", help="atlas file for interior (>0)")
